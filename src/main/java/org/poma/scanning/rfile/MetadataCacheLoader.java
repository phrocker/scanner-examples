 ...
 *
 */
public class MetadataCacheLoader extends CacheLoader<Range,Set<Pair<String,Set<String>>>> {
    ...
    @Override
    public Set<Pair<String,Set<String>>> load(Range inputKey) throws Exception {
        
        Set<Pair<String,Set<String>>> locations = new HashSet<>();
        ...
        try {
            ...
            while (rowIter.hasNext()) {
                ...
                locations.add(new Pair<>(location, fileLocations));
