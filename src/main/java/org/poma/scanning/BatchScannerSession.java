...
public class BatchScannerSession extends ScannerSession implements Iterator<Entry<Key,Value>>, FutureCallback<Scan>, SessionArbiter, UncaughtExceptionHandler {
    ...
    public BatchScannerSession(ScannerSession other) {
        this(other.tableName, other.auths, other.sessionDelegator, other.maxResults, other.options, other.ranges);
     ...
     * @param maxResults
     */
    public BatchScannerSession(String tableName, Set<Authorizations> auths, ResourceQueue delegator, int maxResults,ScannerOptions options,
                               Collection<Range> ranges) {

        super(tableName, auths, delegator, maxResults);
    ...
    protected void submitTasks(List<ScannerChunk> newChunks) {
        ...
        for (ScannerChunk chunk : newChunks) {
            ...
            if (speculativeScanning && delegatedResourceInitializer == RfileResource.class) {
                ...
                chunk.setQueryId(UUID.randomUUID().toString());
