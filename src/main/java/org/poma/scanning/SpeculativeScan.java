 ...
 *
 */
public class SpeculativeScan extends Scan implements FutureCallback<Scan>, Thread.UncaughtExceptionHandler {
    ...
    protected LinkedBlockingDeque<Map.Entry<Key, Value>> myResultQueue;
    ...
    private class SpeculativeScanThreadFactory implements ThreadFactory {
        ...
        public SpeculativeScanThreadFactory(StringBuilder threadName, Thread.UncaughtExceptionHandler handler)
    ...
    public SpeculativeScan(String localTableName, Set<Authorizations> localAuths, ScannerChunk chunk, ResourceQueue delegatorReference,
                           Class<? extends AccumuloResource> delegatedResourceInitializer, ArrayBlockingQueue<Map.Entry<Key,Value>> results, ExecutorService callingService) {
    ...
    public LinkedBlockingDeque<Map.Entry<Key,Value>> getQueue() {
