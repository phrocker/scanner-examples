...
public class ScanSessionStats {
    ...
    public void logSummary(final Logger log) {
        ...
        for (TIMERS timer : TIMERS.values()) {
            ...
            final String paddedCount = new StringBuilder("     ").append(StringUtils.leftPad(countStr, length, "0")).append(") ").toString();
        ...
        sb.append("     ").append("Total elapsed: ").append(formatMillis(totalDurationMillis));
        logToUse.debug(sb.toString());
