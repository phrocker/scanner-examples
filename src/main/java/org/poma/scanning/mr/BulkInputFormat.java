...
import org.poma.scanning.mr.split.DefaultLocationStrategy;
import org.poma.scanning.mr.split.DefaultSplitStrategy;
import org.poma.scanning.mr.split.LocationStrategy;
import org.poma.scanning.mr.split.RangeSplit;
import org.poma.scanning.mr.split.SplitStrategy;
...
public class BulkInputFormat extends InputFormat<Key,Value> {
    ...
    public static void setInputInfo(Job job, String user, byte[] passwd, String table, Authorizations auths) {
        ...
        Preconditions.checkNotNull(passwd);
    ...
    public static void setZooKeeperInstance(Configuration conf, String instanceName, String zooKeepers) {
        ...
        Objects.requireNonNull(instanceName,"Instance name must be provided");
        Objects.requireNonNull(zooKeepers,"Zookeeper quorum name must be provided");
    ...
    public static void fetchColumns(Configuration conf, Collection<Pair<Text,Text>> columnFamilyColumnQualifierPairs) {
        Objects.requireNonNull(columnFamilyColumnQualifierPairs,"CQ pairs must be provided to fetch columns");
     ...
     */
    public static boolean getAutoAdjustRanges(Configuration conf) {
     ...
     * @see #setInputInfo(Job, String, byte[], String, Authorizations)
     */
    public static byte[] getPassword(Configuration conf) throws IOException {
     ...
     */
    public static List<AccumuloIterator> getIterators(Configuration conf) {
